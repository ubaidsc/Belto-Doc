...
export const PaperclipIcon = ({ size = 16 }: { size?: number }) => {
  ...
  <g clipPath="url(#clip0_3107_4998)">
    <path d="M13.5 7.5L13.5 18C13.5 18.3978 13.342 18.7794 13.0607 19.0607C12.7794 19.342 12.3978 19.5 12 19.5C11.6022 19.5 11.2206 19.342 10.9393 19.0607C10.658 18.7794 10.5 18.3978 10.5 18L10.5 4.5C10.5 3.70435 10.8161 2.94129 11.3787 2.37868C11.9413 1.81607 12.7044 1.5 13.5 1.5C14.2956 1.5 15.0587 1.81607 15.6213 2.37868C16.1839 2.94129 16.5 3.70435 16.5 4.5L16.5 18C16.5 19.1935 16.0259 20.3381 15.182 21.182C14.3381 22.0259 13.1935 22.5 12 22.5C10.8065 22.5 9.66193 22.0259 8.81802 21.182C7.97411 20.3381 7.5 19.1935 7.5 18L7.5 7.5" stroke="#FFC201" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </g>
  <defs>
    <clipPath id="clip0_3107_4998">
...
export const SidebarLeftIcon = ({ size = 16 }: { size?: number }) => (
  ...
  <g clipPath="url(#clip0_846_6130)">
    <path d="M5 16H27" stroke="#FFC201" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M5 8H27" stroke="#FFC201" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M5 24H27" stroke="#FFC201" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </g>
  <defs>
    <clipPath id="clip0_846_6130">
